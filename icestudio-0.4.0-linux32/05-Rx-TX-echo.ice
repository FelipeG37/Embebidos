  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "a200944e-0aa6-4ac5-98f6-354bbb2dc699",
          "type": "basic.input",
          "data": {
            "name": "Bt",
            "pins": [
        ...
        {
          "id": "d59d4896-9a66-4cec-b66c-740a1849ae33",
        ...
        {
          "id": "b1b327f6-d441-45a1-b146-540d0bbcaba5",
          "type": "basic.code",
          "data": {
            "code": "reg dato;\nalways@(posedge clk)\nif(rcv==1)\n    begin\n        dato =IN;\n        actuador = dato;\n    end\nelse\n    begin\n        if(BT==0)\n            OUT = dato;\n    end",
            "params": [],
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "a200944e-0aa6-4ac5-98f6-354bbb2dc699",
            "port": "out"
          },
          "target": {
            "block": "d59d4896-9a66-4cec-b66c-740a1849ae33",
        ...
        },
        {
          ...
          "target": {
            "block": "b1b327f6-d441-45a1-b146-540d0bbcaba5",
            "port": "BT"
          }
        },
        {
